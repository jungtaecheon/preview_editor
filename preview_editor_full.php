...
include("./sample_code/table.html");?></textarea>
		...
		<script>
			...
			var htmlInitForm =
				...
				getSpaceByHierarchy(3) + '/* cssを作成してください。 */\n' +
				...
				getSpaceByHierarchy(2) + '<!-- bodyを作成してください。 -->\n' +
				getSpaceByHierarchy(2) + '<a>Hello World!</a>\n' +
				getSpaceByHierarchy(1) + '</body>\n\n' +
				getSpaceByHierarchy(1) + '<script>\n' +
				getSpaceByHierarchy(2) + '// javascriptを作成してください。\n' +
				getSpaceByHierarchy(1) + '<\/script>\n' +
				'</html>';
